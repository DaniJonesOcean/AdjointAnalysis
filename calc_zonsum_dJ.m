function [fldOut,X,Y,weightOut]=calc_zonsum_dJ(fldIn,method,fldType);
% CALC_ZONSUM_DJ(budgIn,method,fldType)
...
%
% DJ additions:
% if fldType is 'dJ' (default), then fldIn is not multiplied by anything (just sum)
